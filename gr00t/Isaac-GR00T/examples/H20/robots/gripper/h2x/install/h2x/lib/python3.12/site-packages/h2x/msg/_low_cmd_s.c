...
bool h2x__msg__motor_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * h2x__msg__motor_cmd__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool h2x__msg__low_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("h2x.msg._low_cmd.LowCmd", full_classname_dest, 23) == 0);
  }
  h2x__msg__LowCmd * ros_message = _ros_message;
  {  // mode_pr
  ...
  {  // motor_cmd
    ...
    Py_ssize_t size = 37;
    h2x__msg__MotorCmd * dest = ros_message->motor_cmd;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!h2x__msg__motor_cmd__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // reserved
    ...
    }
    {
      ...
      Py_ssize_t size = 4;
      uint32_t * dest = ros_message->reserved;
      for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * h2x__msg__low_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("h2x.msg._low_cmd");
  ...
  {  // motor_cmd
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = h2x__msg__motor_cmd__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // reserved
    ...
    uint32_t * src = &(ros_message->reserved[0]);
