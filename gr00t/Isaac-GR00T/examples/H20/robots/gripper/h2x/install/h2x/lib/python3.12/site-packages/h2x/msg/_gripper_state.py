...
class Metaclass_GripperState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from h2x.msg import MotorStateGripper
            if MotorStateGripper.__class__._TYPE_SUPPORT is None:
                MotorStateGripper.__class__.__import_type_support__()
...
class GripperState(metaclass=Metaclass_GripperState):
    ...
    _fields_and_field_types = {
        'tick': 'uint32',
        'motor_state': 'h2x/MotorStateGripper[2]',
        'is_data_valid': 'uint8',
        'crc': 'uint32',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['h2x', 'msg'], 'MotorStateGripper'), 2),  # noqa: E501
    ...
    def __init__(self, **kwargs):
        ...
        self.motor_state = kwargs.get(
            'motor_state',
            [MotorStateGripper() for x in range(2)]
        )
        self.is_data_valid = kwargs.get('is_data_valid', int())
    ...
    def __eq__(self, other):
        ...
        if self.motor_state != other.motor_state:
            return False
        if self.is_data_valid != other.is_data_valid:
            return False
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) == 2 and
                 all(isinstance(v, MotorStateGripper) for v in value) and
                 True), \
                "The 'motor_state' field must be a set or sequence with length 2 and each value of type 'MotorStateGripper'"
        self._motor_state = value

    @builtins.property
    def is_data_valid(self):
        """Message field 'is_data_valid'."""
        return self._is_data_valid

    @is_data_valid.setter
    def is_data_valid(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'is_data_valid' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'is_data_valid' field must be an unsigned integer in [0, 255]"
        self._is_data_valid = value
