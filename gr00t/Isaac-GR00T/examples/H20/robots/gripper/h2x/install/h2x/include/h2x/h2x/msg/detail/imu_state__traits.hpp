...
#ifndef H2X__MSG__DETAIL__IMU_STATE__TRAITS_HPP_
#define H2X__MSG__DETAIL__IMU_STATE__TRAITS_HPP_
...
inline std::string to_yaml(const h2x::msg::IMUState & msg)
{
  return h2x::msg::to_yaml(msg);
}

template<>
inline const char * data_type<h2x::msg::IMUState>()
{
  return "h2x::msg::IMUState";
}

template<>
inline const char * name<h2x::msg::IMUState>()
{
  return "h2x/msg/IMUState";
}

template<>
struct has_fixed_size<h2x::msg::IMUState>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<h2x::msg::IMUState>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<h2x::msg::IMUState>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // H2X__MSG__DETAIL__IMU_STATE__TRAITS_HPP_
