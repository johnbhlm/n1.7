...
{
  new (message_memory) h2x::msg::IMUState(_init);
}

void IMUState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<h2x::msg::IMUState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember IMUState_message_member_array[7] = {
  {
    "quaternion",  // name
    ...
    offsetof(h2x::msg::IMUState, quaternion),  // bytes offset in struct
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(h2x::msg::IMUState, gyroscope),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(h2x::msg::IMUState, accelerometer),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    3,  // array size
    false,  // is upper bound
    offsetof(h2x::msg::IMUState, rpy),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(h2x::msg::IMUState, temperature),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(h2x::msg::IMUState, error_code),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(h2x::msg::IMUState, warning_code),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<h2x::msg::IMUState>()
{
  return &::h2x::msg::rosidl_typesupport_introspection_cpp::IMUState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, h2x, msg, IMUState)() {
  return &::h2x::msg::rosidl_typesupport_introspection_cpp::IMUState_message_type_support_handle;
}
