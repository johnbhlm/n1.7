...
#ifndef H2X__MSG__DETAIL__MOTOR_CMD__STRUCT_HPP_
#define H2X__MSG__DETAIL__MOTOR_CMD__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__h2x__msg__MotorCmd __attribute__((deprecated))
#else
# define DEPRECATED__h2x__msg__MotorCmd __declspec(deprecated)
#endif
...
struct MotorCmd_
{
  ...
  // pointer types
  using RawPtr =
    h2x::msg::MotorCmd_<ContainerAllocator> *;
  using ConstRawPtr =
    const h2x::msg::MotorCmd_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<h2x::msg::MotorCmd_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<h2x::msg::MotorCmd_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      h2x::msg::MotorCmd_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<h2x::msg::MotorCmd_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<h2x::msg::MotorCmd_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<h2x::msg::MotorCmd_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<h2x::msg::MotorCmd_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__h2x__msg__MotorCmd
    std::shared_ptr<h2x::msg::MotorCmd_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__h2x__msg__MotorCmd
    std::shared_ptr<h2x::msg::MotorCmd_<ContainerAllocator> const>
...
using MotorCmd =
  h2x::msg::MotorCmd_<std::allocator<void>>;
...
#endif  // H2X__MSG__DETAIL__MOTOR_CMD__STRUCT_HPP_
