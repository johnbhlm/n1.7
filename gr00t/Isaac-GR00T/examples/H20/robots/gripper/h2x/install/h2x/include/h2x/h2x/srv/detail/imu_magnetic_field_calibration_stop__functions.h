...
// IWYU pragma: private, include "h2x/srv/imu_magnetic_field_calibration_stop.h"


#ifndef H2X__SRV__DETAIL__IMU_MAGNETIC_FIELD_CALIBRATION_STOP__FUNCTIONS_H_
#define H2X__SRV__DETAIL__IMU_MAGNETIC_FIELD_CALIBRATION_STOP__FUNCTIONS_H_
...
/// Initialize srv/IMUMagneticFieldCalibrationStop message.
/**
 ...
 * )) before or use
 * h2x__srv__IMUMagneticFieldCalibrationStop_Request__create()
...
/// Finalize srv/IMUMagneticFieldCalibrationStop message.
/**
...
/// Create srv/IMUMagneticFieldCalibrationStop message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * h2x__srv__IMUMagneticFieldCalibrationStop_Request__init().
...
/// Destroy srv/IMUMagneticFieldCalibrationStop message.
/**
 * It calls
 * h2x__srv__IMUMagneticFieldCalibrationStop_Request__fini()
...
/// Check for srv/IMUMagneticFieldCalibrationStop message equality.
/**
...
/// Copy a srv/IMUMagneticFieldCalibrationStop message.
/**
...
/// Initialize array of srv/IMUMagneticFieldCalibrationStop messages.
/**
...
/// Finalize array of srv/IMUMagneticFieldCalibrationStop messages.
/**
 * It calls
 * h2x__srv__IMUMagneticFieldCalibrationStop_Request__fini()
...
/// Create array of srv/IMUMagneticFieldCalibrationStop messages.
/**
 * It allocates the memory for the array and calls
 * h2x__srv__IMUMagneticFieldCalibrationStop_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/IMUMagneticFieldCalibrationStop messages.
/**
 * It calls
 * h2x__srv__IMUMagneticFieldCalibrationStop_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/IMUMagneticFieldCalibrationStop message array equality.
/**
...
/// Copy an array of srv/IMUMagneticFieldCalibrationStop messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * h2x__srv__IMUMagneticFieldCalibrationStop_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_h2x
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * h2x__srv__IMUMagneticFieldCalibrationStop_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_h2x
...
/**
 * It calls
 * h2x__srv__IMUMagneticFieldCalibrationStop_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_h2x
...
/**
 * It allocates the memory for the array and calls
 * h2x__srv__IMUMagneticFieldCalibrationStop_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_h2x
...
/**
 * It calls
 * h2x__srv__IMUMagneticFieldCalibrationStop_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * h2x__srv__IMUMagneticFieldCalibrationStop_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_h2x
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * h2x__srv__IMUMagneticFieldCalibrationStop_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_h2x
...
/**
 * It calls
 * h2x__srv__IMUMagneticFieldCalibrationStop_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_h2x
...
/**
 * It allocates the memory for the array and calls
 * h2x__srv__IMUMagneticFieldCalibrationStop_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_h2x
...
/**
 * It calls
 * h2x__srv__IMUMagneticFieldCalibrationStop_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // H2X__SRV__DETAIL__IMU_MAGNETIC_FIELD_CALIBRATION_STOP__FUNCTIONS_H_
