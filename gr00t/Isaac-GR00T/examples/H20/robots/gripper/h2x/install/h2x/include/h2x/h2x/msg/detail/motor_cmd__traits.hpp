...
#ifndef H2X__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
#define H2X__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
...
inline std::string to_yaml(const h2x::msg::MotorCmd & msg)
{
  return h2x::msg::to_yaml(msg);
}

template<>
inline const char * data_type<h2x::msg::MotorCmd>()
{
  return "h2x::msg::MotorCmd";
}

template<>
inline const char * name<h2x::msg::MotorCmd>()
{
  return "h2x/msg/MotorCmd";
}

template<>
struct has_fixed_size<h2x::msg::MotorCmd>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<h2x::msg::MotorCmd>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<h2x::msg::MotorCmd>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // H2X__MSG__DETAIL__MOTOR_CMD__TRAITS_HPP_
