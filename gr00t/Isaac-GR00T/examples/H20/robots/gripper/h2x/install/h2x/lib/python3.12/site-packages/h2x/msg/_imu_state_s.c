...
bool h2x__msg__imu_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("h2x.msg._imu_state.IMUState", full_classname_dest, 27) == 0);
  }
  h2x__msg__IMUState * ros_message = _ros_message;
  {  // quaternion
...
PyObject * h2x__msg__imu_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("h2x.msg._imu_state");
